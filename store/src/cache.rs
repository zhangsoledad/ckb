...
impl Default for StoreCache {
    fn default() -> Self {
        StoreCache {
            headers: Mutex::new(LruCache::new(4096)),
            cell_data: Mutex::new(LruCache::new(128)),
            block_proposals: Mutex::new(LruCache::new(30)),
            block_tx_hashes: Mutex::new(LruCache::new(30)),
            block_uncles: Mutex::new(LruCache::new(30)),
            cellbase: Mutex::new(LruCache::new(30)),
        }
    }
}
