...
${GEN_FILES}:
	${MOLC} util/types/schemas/ckb.mol util/types/src/generated/
	mv util/types/src/generated/ckb.rs util/types/src/generated/types.rs
	rustfmt util/types/src/generated/types.rs
