...
.PHONY: probe-prod
probe-prod: ## Build binary for production release.
	RUSTFLAGS='--cfg probe' cargo build ${VERBOSE} ${CKB_BUILD_TARGET} --profile prod --features "with_sentry,with_dns_seeding"
